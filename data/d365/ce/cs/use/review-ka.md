...
|To|Do the following|  
|--------|-------------|  
|Pick an article assigned to you|In Customer Service app: <br /><br /> Go to **Dashboard** > **My Knowledge Dashboard**, and then see the **My Active Articles** stream.<br /><br /> **-OR-**<br /><br /> Go to **Queues**, and then select the **Items available to work on** view.|  
